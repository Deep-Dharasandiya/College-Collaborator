...
export default class ShowFacultyList extends React.Component{
    state = {
        FacultyDetails:'',
        loader:true,
        CollageID:'',
        ...
        return(
          <View>
           {this.state.loader==false ?
             <View>
                {this.state.FacultyDetails != ''?
                 <View   style={{marginTop:50}}>
                    {
                    this.state.FacultyDetails.map((item, index) => (
                        <ScrollView>
                        <TouchableOpacity
                            key = {item._id}
                        >
                                    ...
                                    <View style={styles.middle_circle_right_position}>
                                        <View  style={{flexDirection:'row'}}>
                                            {/* <Icon
                                                ...
                                                size={20}
                                            /> */}
                                            <Text style={{marginLeft:10,color:'white',fontSize:20,fontWeight:'bold'}}>{item.faculty_firstname+' '+item.faculty_lastname}</Text>
                                        </View>
                                        ...
                                        <View  style={{flexDirection:'row'}}>
                                            {/* <Icon
                                                ...
                                                size={20}
                                            /> */}
                                            <Text style={{marginLeft:10,color:'white',fontSize:15,fontWeight:'500'}}>{item.co_no}</Text>
                                        </View>
                                        <View  style={{flexDirection:'row'}}>
                                            {/* <Icon
                                                name="email"
                                                ...
                                                size={20}
                                            /> */}
                                            <Text style={{marginLeft:10,color:'white',fontSize:15,fontWeight:'500',flexShrink: 1}}>{item.faculty_email}</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
