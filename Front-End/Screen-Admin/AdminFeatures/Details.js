...
//             <View>
//               <TouchableOpacity 
//                  onPress={()=>this.props.navigation.navigate('ShowStudentList')}
//                 >
//                     <Text  style={{paddingTop:300}} >Show student list</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity 
//                  onPress={()=>this.props.navigation.navigate('ShowFacultyList')}
//                 >
//                     <Text  style={{paddingTop:20}} >Show faculty list</Text>
//                 </TouchableOpacity>
//             </View>
//         );
//     }
    ...
    render(){
        ...
        >
            <ScrollView showsVerticalScrollIndicator={false}>
                <Text style={styles.top_text}>Details</Text>
