...
import FacultyFeatuers from './FacultyFeatuers';
      ...
      return (
          ...
          return (
              <SafeAreaView style={{ flex: 1 },{paddingVertical:50}} >
                  ...
                  <TouchableOpacity
                  onPress={()=>this.removeItemValue('auth','urrontAdminDetails')}>
        ...
        >
          <Drawer.Screen name="Home" component={facultyhome} options={{headerShown:false}} />
  ...
  render(){
    return(
      <Tab.Navigator tabBarOptions={{ showIcon: true }} tabBarPosition={'bottom'} tabBar={props => <MyTabBar {...props} />}  >
        <Tab.Screen name="Home" component={FacultyFeatuers} />
